...
run_test() {
    ...
    then
        let "SUCCESS++"
        echo "$COUNTER -  \033[1;32mSuccess $param\033[0m"
    else
        let "FAIL++"
        echo "$COUNTER - \033[1;31mFail $param\033[0m"
    fi
...
printf "\n"
echo "\033[1;31mFAILED: $FAIL\033[0m"
echo "\033[1;32mSUCCESSFUL: $SUCCESS\033[0m"
echo "ALL: $COUNTER"
printf "\n"
##############################
